 ...
 * @returns {string|null}
 */
export function translateMeteoAlertEventFromTags(tags) {
 ...
 * @returns {string}
 */
export function translateMeteoAlertSender(sender) {
 ...
 * @returns {string}
 */
export function translateMeteoAlertEvent(event, tags) {
 ...
 * @returns {string}
 */
export function translateMeteoAlertDescription(description) {
 ...
 */
export function localizeMeteoAlerts(alerts) {
