/**
 * Parser entity-first per aggiunta terreno (pagina Terreni).
 * Mirror di functions/tony-terreno-entity-parser.js — risposta istantanea senza CF/Gemini.
 */
...
export function isOnTerreniPage(ctx) {
...
export function isTerrenoCreationIntent(message) {
 ...
 */
export function tryTonyTerrenoEntityParse(input) {
