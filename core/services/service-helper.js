    ...
    return callService('terreni', 'getAllTerreni', {
        ...
        converter: (t) => {
            ...
            const base = {
                ...
                coltura: originalData.coltura || t.coltura || null,
                colturaCategoria: originalData.colturaCategoria || t.colturaCategoria || null,
                colturaSottocategoria: originalData.colturaSottocategoria || t.colturaSottocategoria || null,
                tipoCampo: originalData.tipoCampo || t.tipoCampo || null,
                tipoPalo: originalData.tipoPalo || t.tipoPalo || null,
                sestoImpianto: originalData.sestoImpianto || t.sestoImpianto || null,
                vendemmiaMeccanica: originalData.vendemmiaMeccanica || t.vendemmiaMeccanica || null,
