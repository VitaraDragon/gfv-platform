#!/usr/bin/env node
/**
 * Canary roster A2 + nav impegni in CI: emulators:exec + http-server + sim:run + canary.
 * Richiede Java su PATH e Chromium Playwright (`npm run sim:e2e:install`).
 * @module simulator/ci-manodopera-roster-a2-run
 */
...
const innerScript = join(root, 'scripts/sim-ci-manodopera-roster-a2-inner.sh');
