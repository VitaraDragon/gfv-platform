...
| 26.4 | Telefono: catalogo in sheet (si chiude dopo la scelta). PC: menu a sinistra a scomparsa. La graffetta è solo icona, anche sul telefono (niente «Tocca per i moduli»). Sotto i 1024 px titolo, cartina e ingranaggio stanno in riga e il titolo lungo si accorcia; le statistiche seguono 1 colonna sotto 480 px e 2 fino a 768. Notch e barra gesti via `viewport-fit=cover` | prodotto 2026-09-22, aggiornato 2026-09-26 | **parziale** | Sul telefono la scritta sostituiva l’icona. Campo e login no |
