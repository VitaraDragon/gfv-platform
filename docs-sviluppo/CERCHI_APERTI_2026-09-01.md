...
> **Snapshot 2026-09-01.** Dopo questa data sono stati chiusi in codice (tra gli altri): lettura pubblica inviti, giacenza magazzino atomica, delete lavoro a cascata, lock preventivi, scarico trattamenti in prova. Per lo stato di oggi: `tony/STATO_ATTUALE.md` e `COSA_ABBIAMO_FATTO.md`.
