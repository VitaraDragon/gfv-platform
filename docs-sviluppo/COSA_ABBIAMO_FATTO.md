...
- Nessuna modifica a `core/` (niente bump cache PWA). Test: `tests/tony-tenant-plan-gate.test.js` (8), `tests/stripe-checkout-fulfillment.test.js` (10, Firestore/Stripe finti); `npm run sim:tony:vitest` 50 file / 532 ✅.
