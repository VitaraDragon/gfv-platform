...
**Data**: 2026-06-14 (… **fix loop mic auto-mode** build `2026-06-14b`; **merge multi-PC** + E2E vocale lavoro PWA; **latenza baseline** `2026-06-14a` …)  
...
| Voice / TTS | `core/js/tony/voice.js` + **`functions/index.js` (`getTonyAudio`)** | ✅ **Chirp 3 HD Charon (2026-06-13)**; cache MP3 keyed su **testo + voice**; … **latenza auto-mode ↓** build `2026-06-14a`; **riapertura mic unificata** `scheduleMicReopenInAutoMode` (no loop onend/TTS/speechend vuoto — `2026-06-14b`); test `tony-stream-tts-chunk.test.js`, `tony-voice-pipeline-canary.test.js` |
