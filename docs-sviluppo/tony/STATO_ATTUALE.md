...
**Data**: 2026-06-14 (… **merge multi-PC** ✅ Chirp 3 + intervista lavoro + hub manodopera + lavoro locale; **E2E vocale lavoro** ✅ seconda macchina `build 2026-06-14a`; **Terreno** entity parser client + CF early exit; **tony-service** HTTP callable + SSE abort; **Latenza auto-mode** baseline 220/450/350/100 ms …)  
