...
**Data**: 2026-07-31 (… **roster A2 UI** — 2026-07-31; **nav B hub manodopera** — 2026-07-31; **APRI_PAGINA impegni PAGE_MAP** — 2026-07-31; **CB manodoperaGiorno** — 2026-07-27; …)  
**Fonte**: codice + `TONY_DECISIONI_E_REQUISITI.md` (… **manodoperaGiorno CB** — 2026-07-27; **roster partecipazioni** — 2026-07-27; **segna-ore trust ore tonde** — 2026-07-27; …)  
...
| **Sostituzioni manodopera** (assenze → shortlist → sostituto) | `manodopera-sostituti-shortlist-*.js`, `lavoro-sostituzione-assenza-service.js`, `manodopera-sostituzione-policy-config.js`, `gestione-lavori-sostituti-ui.js`, assenze/standby | ✅ **Oltre MVP:** shortlist + prestito + equipaggio + `equipaggioGiorno`. **2026-07-27:** roster A1 + Slice B CB. **2026-07-31:** A2 «Scegli manualmente» + canary locale + **gate CI** `manodopera-roster-a2-canary` in `simulator-ci.yml`. **Da fare:** pool riserve; DnD opz. Piano: `docs-sviluppo/da-fare/tony/PIANO_SOSTITUZIONE_MANODOPERA_SQUADRE.md` |
| **Vista impegni giornalieri** (manager) | `manodopera-impegni-giorno-*.js`, `manodopera-roster-giorno-*.js`, `manodopera-roster-edit-ui.js`, `impegni-giornalieri-standalone.html`, hub + Gestione lavori + `tony-routes.json` | ✅ Foto giorno + roster. **A2** demoted a «Scegli manualmente…» (secondario; shortlist resta primaria — 2026-07-31). `currentTableData` `impegni_giornalieri`. |
