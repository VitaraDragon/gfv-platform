...
| Manodopera — scheda / skill | `core/config/manodopera-skills-config.js`, `profilo-manodopera-service.js`, `profilo-manodopera-batch.js`, `profilo-manodopera-skill-batch-service.js`, `gestione-operai-standalone.html` | ✅ Skill dichiarate (manager); **batch ore validate → `skillCalcolate` + stelline** (12 mesi, pulsante «Aggiorna stelline da ore»); shortlist sostituti / assenze ancora da fare — 2026-05-16 |
