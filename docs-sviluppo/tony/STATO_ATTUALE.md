...
**Data**: 2026-09-18 (… **Magazzino scarico trattamenti: gate trial** — 2026-09-18; **Tony Occhi: galleria + HEIC→JPEG** — 2026-09-17; **chat Tony iPhone: tastiera visualViewport + viewport-fit/safe-area** — 2026-09-17; **chat Tony iPhone: pannello 100dvw + riga 📷 visibile** — 2026-09-17; **voce iPhone: recorder su tutto iOS + sblocco TTS** — 2026-09-16; …)  
...
| **Gestione lavori — delete a cascata** | `lavori-service.js` (`countRelatedLavoroData`, `deleteLavoroCascade`, `purgeOrphanComunicazioni`), `gestione-lavori-events.js`, `raccolta-frutta-service.js`, `field-workspace-controller.js` | ✅ **2026-08-07:** conferma con conteggi; elimina ore/zone/comunicazioni/diario/assenze/crop+raccolta/calcoli VM; unlink preventivi/guasti; blocco se riprese figlie; **purge comunicazioni orfane** + filtro UI capo se `lavoroId` morto |
