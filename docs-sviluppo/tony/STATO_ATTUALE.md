...
| **Zona due punti (geometria)** | `core/js/zona-lavorata-slice.js` | ✅ **2026-09-04:** tagli allineati ai lati del campo (obb), non alla corda I→F. Test: `tests/zona-lavorata-slice.test.js` |
