...
**Data**: 2026-07-10 (… **Tony Occhi design** — acquisizione documenti chat-first; … **Tony E2E flake fix** — T-FLOW-013 terreno post-save + T-FLOW-014-LIVE metriche CF; … **Tony E2E CI** — push + dispatch verde; … **Tony E2E M-T5** — suite tier 3 live + gate p95; …)  
