...
**Data**: 2026-06-20 (… **sessione voce** build **`2026-06-20r`** — modalità continua, reconcile TTS, STT `?`; **fix TTS doppio mobile/PWA** `2026-06-20a`; …)  
...
| **6** | Proattività e memoria | ⏳ Parziale | … **modalità vocale continua** stabilizzata (`2026-06-20o`–`r`: mic reopen post-TTS, reconcile frasi, STT `?`); **Tony consigliere moduli** (Base — 2026-06-19); **TTS** chunking + pipeline latenza; **fix doppio TTS stream mobile/PWA** (`2026-06-20a`); … |
