...
**Data**: 2026-09-05 (… **Tony lazy-load + intro.js non scaricato** — 2026-09-05; **dashboard meteo/Maps lazy** — 2026-09-04; **flag prova + switch dashboard** — 2026-09-04; **zona lavorata due punti** — 2026-09-03; **push S5 assenze + WhatsApp** — 2026-08-28; …)  
...
| **Briefing proattivo (dashboard + hub)** | `tony-proactive-briefing-policy.js`, `tony-proactive-signals.js`, `tony-proactive-hub-briefing.js`, `dashboard-standalone.html` + home hub | ✅ **§15.5–§15.6 v1** + **`prezziInAttesa`** (2026-07-21b). Hub Magazzino: prodotti da completare, scorte, bolle senza prezzo. Follow-up «apri» → Movimenti filtrati. |
...
| SUM_COLUMN | ✅ terreni |
| RIASSUNTO (tonyGlobalBriefing) | ✅ Dashboard: `buildDashboardRiassuntoText` + ops con nomi (`summary*`). Hub: **non** offrire riassunto nel reminder; se chiesto → `buildHubProactiveRiassuntoReply` (guida «apri»/Dashboard, no eco conteggi) — 2026-07-21a. «sì/ok» solo dopo offerta riassunto (tipicamente dashboard). |
