...
**Data**: 2026-07-21 (… **proattività reminder v1 chiusa** — segnali affitti/approvare/sospesi + UX hub senza riassunto eco, build `2026-07-21a` — 2026-07-21; **proattività §15.5–§15.6** hub entry 6 moduli — 2026-07-20; **nav slide ore/lavori + doppio FAB** — build `2026-07-17e`–`f` — 2026-07-17; …)  
**Fonte**: codice + `TONY_DECISIONI_E_REQUISITI.md` (… **proattività multi-hub + UX hub** — 2026-07-21; **hub navigazione manodopera manager** — 2026-06-13; …)  
...
| **6** | Proattività e memoria | ⏳ Parziale | **§15.5–§15.6** ✅ v1 reminder (dashboard + 6 hub, build `2026-07-21a`); **§15.4** memoria storica da fare |
...
| **Briefing proattivo (dashboard + hub)** | `tony-proactive-briefing-policy.js`, `tony-proactive-signals.js`, `tony-proactive-hub-briefing.js`, `dashboard-standalone.html` + home hub | ✅ **§15.5–§15.6 v1 chiusa** (2026-07-21). Hub: `offerRiassunto: false` + «apri». Segnali: affitti/approvare/sospesi + pool precedente. Build `2026-07-21a`. Test **16+13**. |
...
| Proattività §15.6 reminder multi-modulo (catalogo + follow-up + hub) | — | ✅ **2026-07-20/21** — v1 chiusa (hub UX + affitti/approvare/sospesi); build `2026-07-21a` |
