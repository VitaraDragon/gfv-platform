...
**Data**: 2026-06-09 (… **Voce dashboard Tony** ✅ build `2026-06-09g`: meteo locale, riassunto ops+meteo, addio senza CF, TTS senza troncamento/eco — verifica console utente; **Dashboard boot performance Fasi 0–4** ✅ summary ~861 ms; …)  
