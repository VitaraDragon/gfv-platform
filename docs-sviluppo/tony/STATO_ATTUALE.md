...
**Data**: 2026-07-20 (… **proattività §15.5–§15.6** — dashboard fasce/delta + catalogo + follow-up «apri» + hub entry Manodopera/Magazzino/Vendemmia/CT/Macchine/Frutteto — 2026-07-20; **nav slide ore/lavori + doppio FAB** — build `2026-07-17e`–`f`, ✅ verificato utente — 2026-07-17; **nav vocale comunicazioni profilo campo** — `tryTonyFieldNavQuickReply` + target `comunicazioni`, build `2026-07-17a`–`d` — 2026-07-17; **fix vocale Segna ore «dalle X alle Y»** — ricostruzione ITN `dalle H:MM`, build `2026-07-15p`, verificato utente — 2026-07-15; **catena ripresa → chiusura lavoro sospeso** — repair al reload gestione lavori — 2026-07-15; … **PR #5 merge** — segna ore unificato + gate Tony **17/17** CI ~4m27s — 2026-07-11; …)  
**Fonte**: codice + `TONY_DECISIONI_E_REQUISITI.md` (… **proattività multi-hub** — 2026-07-20; **hub navigazione manodopera manager** — 2026-06-13; **manodopera validazione ore capo→manager + field workspace slide Valida ore** — 2026-05-19)  
...
| **6** | Proattività e memoria | ⏳ Parziale | **§15.5–§15.6** ✅ v1 dashboard + 6 hub (2026-07-20); **§15.4** memoria storica da fare |
...
| **Briefing proattivo (dashboard + hub)** | `tony-proactive-briefing-policy.js`, `tony-proactive-signals.js`, `tony-proactive-hub-briefing.js`, `dashboard-standalone.html` + home hub | ✅ **§15.5** fasce/delta/storage; **§15.6** catalogo + follow-up «apri» + hub Manodopera/Magazzino/Vendemmia/CT/Macchine/Frutteto. Build client `2026-07-20b`. Test **13+13**. |
...
| **Tony Occhi — acquisizione documenti** | CF + review + register + **sicurezza A+B + fail-closed** + prezzo medio | ⏳ **Fase 0–3** — layout-agnostic §20.15. 📷 → revisione → Registra (dati gestionale). **Foto non persistite** oggi. **Archivio Magazzino** (Storage + lista filtrabile + link movimenti) deciso §20.33 — **pianificato**. Futuro §20.32 bolle merce prodotta. Tony `2026-07-19d`. **Piano §17**: A–F ✅; prossimo **G** / archivio. |
...
| Proattività §15.6 reminder multi-modulo (catalogo + follow-up + hub) | — | ✅ **2026-07-20** — hub manodopera/magazzino/vendemmia/CT/macchine/frutteto |
