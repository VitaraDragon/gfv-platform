...
| Voice / TTS | `core/js/tony/voice.js` + **`functions/index.js` (`getTonyAudio`)** + **`core/js/tony/stream-tts-chunk.js`** | ✅ **build `2026-06-20l`**; voce stream + reconcile; mic no auto reload; **briefing dashboard** con retry; test canary |
