...
| Voice / TTS | `core/js/tony/voice.js` + **`functions/index.js` (`getTonyAudio`)** + **`core/js/tony/stream-tts-chunk.js`** | ✅ **build `2026-06-20k`**; voce: stream + reconcile remainder; **mic non auto al reload**; test stream/voice canary |
