...
**Data**: 2026-09-14 (… **pipeline foto parallela / thinking off** — 2026-09-14; **guide foto bolla/fattura** — 2026-09-12; **disegno 1b terreni clienti CT** — 2026-09-06; **proposta confine tap no-go / SAM abbandonato** — 2026-09-05; …)  
...
| **Tony Occhi — acquisizione documenti** | CF + review + register + sicurezza A+B + prezzo medio + **archivio** + reminder prezzi | ✅ **Fase 0–3 + Archivio MVP + `prezziInAttesa`** (2026-07-21b). **2026-09-11:** promessa 📷 invariata; due passate Gemini su foto/PDF per i numeri; XML extra silenzioso. **2026-09-12:** guide + CF in produzione. **2026-09-14:** OCR+JSON in parallelo, thinking off, reconcile solo testo (cifre invariate, meno attesa); **CF aggiornata in produzione**. Futuro §20.32; P7 retention. **Brand «Occhi» solo interno**; UI: foto/PDF + Tony in prima persona. |
