...
| **Tony Occhi — acquisizione documenti** | CF + review + register + sicurezza A+B + prezzo medio + **archivio** + reminder prezzi | ✅ **Fase 0–3 + Archivio MVP + `prezziInAttesa`** (2026-07-21b). **2026-09-11:** FatturaPA XML deterministico + OCR due passate Gemini (foto/PDF) + `responseSchema`. 📷 accetta XML. Futuro §20.32; P7 retention. **Brand «Occhi» solo interno**; UI: foto/PDF/XML + Tony in prima persona. |
