...
| Manodopera — scheda / skill | `core/config/manodopera-skills-config.js`, `profilo-manodopera-service.js`, `profilo-manodopera-batch.js`, `profilo-manodopera-skill-batch-service.js`, `profilo-manodopera-skill-auto-refresh.js`, `gestione-operai-standalone.html` | ✅ Skill dichiarate; **stelline auto** su validazione ore (debounce) + batch manuale tenant; shortlist/assenze da fare — 2026-05-16 |
