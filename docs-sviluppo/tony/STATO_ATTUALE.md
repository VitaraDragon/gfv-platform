...
**Data**: 2026-06-06 (… **Dashboard boot performance Fasi 0–4** ✅ summary ~861 ms; snapshot conteggi + Tony deferred; **Segna ore workspace campo E2E ✅** …)  
...
| Voice / TTS | `core/js/tony/voice.js` | ✅ `expandSpokenUnitsForItalianTTS`; **`prefetchTonyTTS`** warm cache MP3; **`clearTonyAudioPipeline`** + **`__tonyGeneration`** (cancel logico TTS stale, Fase 1 barge-in — 2026-06-07); `main.js` wiring turno/barge-in/chiusura pannello |
