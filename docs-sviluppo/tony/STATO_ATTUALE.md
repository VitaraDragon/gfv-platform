...
**Data**: 2026-07-15 (… **fix vocale Segna ore «dalle X alle Y»** — ricostruzione ITN `dalle H:MM`, build `2026-07-15p`, verificato utente — 2026-07-15; **catena ripresa → chiusura lavoro sospeso** — repair al reload gestione lavori — 2026-07-15; … **PR #5 merge** — segna ore unificato + gate Tony **17/17** CI ~4m27s — 2026-07-11; …)  
