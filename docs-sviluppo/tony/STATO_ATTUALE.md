...
**Data**: 2026-06-13 (… **Hub Manodopera Fase 1** ✅ home modulo + card dashboard + Tony `manodopera` → hub; **performance pagine admin manodopera** ✅ loader condiviso `manodopera-lavori-ore-loader.js`; … **Voce dashboard Tony** ✅ build `2026-06-09g` …)  
