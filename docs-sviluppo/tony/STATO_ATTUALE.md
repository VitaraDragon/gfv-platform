...
**Data**: 2026-07-21 (… **Archivio Occhi Magazzino MVP** + **`prezziInAttesa`** §15.6, build `2026-07-21b` — 2026-07-21; **proattività reminder v1** hub UX + affitti/approvare/sospesi — 2026-07-21; **proattività §15.5–§15.6** hub entry 6 moduli — 2026-07-20; **nav slide ore/lavori + doppio FAB** — build `2026-07-17e`–`f` — 2026-07-17; …)  
**Fonte**: codice + `TONY_DECISIONI_E_REQUISITI.md` (… **§20.33 archivio** + **`prezziInAttesa`** — 2026-07-21; **proattività multi-hub** — 2026-07-21; **hub navigazione manodopera manager** — 2026-06-13; …)  
