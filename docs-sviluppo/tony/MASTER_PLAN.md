...
- **Mappe**: Tony non traccia poligoni. Può aprire le pagine con mappe; il tracciamento resta manuale. **Proposta confine da tap** (design 2026-08-28, **no-go / abbandonato** 2026-09-05): il segmentatore a macchie (SAM) non è usabile; si traccia a mano. **Fase 1b ✅ 2026-09-05** Terreni, **✅ 2026-09-06** terreni clienti CT: chiusura / doppio tap / snap vicini (`TONY_DECISIONI_E_REQUISITI.md` §21.14). Piano: `docs-sviluppo/obsoleto/strategie-superate/PIANO_PROPOSTA_CONFINE_TAP.md` (`TONY_DECISIONI_E_REQUISITI.md` §21).
...
- **Piano performance dashboard panoramica** (Fase 0–**5** ✅ 2026-06-06; canary giugno **`dashboard pronta` ~861 ms**; **addendum 2026-09:** meteo fuori da «pronta» + Maps lazy lista lavori + Tony lazy-load — Sabbie ~1,1 s / 0,56 s; smoke `npm run dashboard:perf-smoke`): `docs-sviluppo/dashboard/PLAN_PERFORMANCE_DASHBOARD.md`
...
- **Terreni – proposta confine da tap** (**abbandonato**, no-go 2026-09-05): `docs-sviluppo/obsoleto/strategie-superate/PIANO_PROPOSTA_CONFINE_TAP.md` — SAM/macchie non usabile come proposta; niente Gemini sul perimetro; Tony non traccia poligoni. **1b ✅** disegno a mano più veloce (Terreni 2026-09-05; terreni clienti CT 2026-09-06)
