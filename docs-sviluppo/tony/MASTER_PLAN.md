...
| **6** | Proattività e memoria | ⏳ Parziale | **§15.5–§15.6** ✅ v1 (dashboard + 6 hub); **§15.4** memoria storica ancora da fare. |
...
- **Implementato (2026-07-20):** **§15.5** anti-invasività (fasce + delta + storage tenant); **§15.6** catalogo segnali + follow-up «apri» + **hub entry** su Manodopera, Magazzino, Vendemmia, Conto terzi, Parco macchine, Frutteto. Test catalogo **13** + policy **13**. Dettaglio: `TONY_DECISIONI_E_REQUISITI.md` §15.5–§15.6.
- Da fare: **memoria storica** (§15.4 confronti anno/anno); **card/chip Abbonamento** da `consigliModuli` (backlog marketing §8 handoff)
