# Magazzino — sintesi per Tony

Modulo **Magazzino** attivo sull'azienda. Linguaggio allineato alla guida utente.
...
- **Tony**: su **Prodotti** e **Movimenti** può spesso leggere l’**elenco tabellare** come lo vedi tu (stessi filtri e righe visibili; dove la pagina lo consente può applicare **filtri** sulla lista); su **Tracciabilità consumi** vale lo stesso per la tabella dedicata; altrove preferire **passi procedurali** dalla guida lunga.
